...
<body>
	...
	<div class="container">
		...
		<table id = "dataTable" 
		    ...
		    <tr>
				...
				<th data-class="goodsCode" data-field="goodsCode" data-halign="center" data-align="center">상품코드</th>		        
		        ...
		        <th data-class="orderQty" data-field="orderQty" data-halign="center" data-align="right">주문수량</th> <!-- 09/19 반영사항 -->
		        <!-- <th data-class="pickQty" data-field="pickQty" data-halign="center" data-align="right">피킹수량</th> -->
		        <th data-class="changeGoodsCode" data-field="changeGoodsCode" data-halign="center" data-align="center">대체코드</th>
		        <th data-class="changeGoodsName" data-field="changeGoodsName" data-halign="center" data-align="left">대체상품명</th>		        
		        <th data-class="changeGoodsCost" data-field="changeGoodsCost" data-halign="center" data-align="right">대체가격</th>
		        <th data-class="changePickQty" data-field="changePickQty" data-halign="center" data-align="right">대체수량</th> <!-- 09/19 반영사항 -->
		        <th data-class="soldOutReason" data-field="soldOutReason" data-halign="center" data-align="left">대체사유</th> 
		        <th data-class="comName" data-field="comName" data-halign="center" data-align="center">피커명</th>
		        <!-- <th data-class="changeAllowYn" data-field="changeAllowYn" data-halign="center" data-align="center">대체허용</th>
				<th data-class="goodsSpec" data-field="goodsSpec" data-halign="center" data-align="left">상품규격</th>
		        <th data-class="makerName" data-field="makerName" data-halign="center" data-align="left">제조사명</th>
		        <th data-class="salesGoodsCode" data-field="salesGoodsCode" data-halign="center" data-align="right">판매상품코드</th>
		        <th data-class="goodsOptionName" data-field="goodsOptionName" data-halign="center" data-align="left">옵션명</th>
		        <th data-class="taxType" data-field="taxType" data-halign="center" data-align="left">과세구분</th>
		        <th data-class="categoryLarge" data-field="categoryLarge" data-halign="center" data-align="left">전시카테고리_대</th>
		        <th data-class="categoryMiddle" data-field="categoryMiddle" data-halign="center" data-align="left">전시카테고리_중</th> -->
		...
		<!-- <table>
			<tr>
				<td>
			    	* 다운로드 한 엑셀 파일은  D: 드라이브의 상품결품대체현황엑셀 폴더에 다운로드 되어 있습니다.
			    </td>
		    </tr>
		</table> -->
    ...
    <script>
    	...
    	onMsoNumberFormat = function(cell, row, col) {
	   		// 단축주문번호 , 경통코드, (text 처리) Add20161031 osj 대체경통코드 추가 
    		if (row > 0 && (col == 2 
    					|| col == 6 || col == 13)) {
    		  return "\\@";
    		 }
    	...
    	// 페이지 로드시 처리
   	    $(function(){
   	    	...
   	    	$('#btnExcelExport').on('click',function(){
   	    		...
   	    		$("#searchForm").attr("action","/excelChangeStateList.do");
   	    		$("#searchForm").submit();
   	    	...
   	    	$(".btnSearch").on("click",function(e){
   	    		$("#searchForm").attr("action","/changeStateList.do");
   	    		$("#searchForm").submit();
   	    	});
           ...
           $dataTable.bootstrapTable({data: <%= new ObjectMapper().writeValueAsString(request.getAttribute("changePickList"))%> });
      	   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
