...
public class TestIreport2 {

	public static void main(String[] args) throws Exception {

		String jrxmlFileName = "c:/ireport/specifications.jrxml";
		String jasperFileName = "c:/ireport/specifications.jasper";
		String destFileName = "c:/ireport/specifications.pdf";
...
//				_itemVO.setLck_knd(_itemVO.LCK_KND_PARK_LACK); // 부분결품
		...
		params.put("free_gift_name", "Y"); // 사은품
